...
#import "VFI_ISCP_HIGH.h"
#import <UIKit/UIKit.h>
#import "VFIAccessoryMgr.h"
#import "VFIStream.h"
#import "VFI_Barcode_host.h"
...
typedef enum  {
    ...
    BCS_TRIGGER_FRAME_PRESSED        //!< e355 Frame Trigger Pressed
} triggerResponse;
 ...
 * @endcode
 */
-(void) sendISCP:(VFI_ISCP_HIGH*)frame;
 ...
 *
 *Note: In Continuous mode, the maximum allowed timeout value is 255 seconds. In Single Scan mode, the maximum allowed timeout value is 10 seconds.
 */
 ...
 * Sends trigger status to the delegate VFIBarcodeDelegate::barcodeTriggerEvent:()
 ...
 - 4: Frame Triggers Pressed (e355 Frame Only)
 */
-(int) mButtonStatus;
/**
...
#else
    @property (strong) id <VFIBarcodeDelegate> delegate;
#endif
