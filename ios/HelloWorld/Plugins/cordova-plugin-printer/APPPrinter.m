...
- (void) print:(CDVInvokedUrlCommand*)command
{
    ...
    [self loadContent1:[arguments objectAtIndex:0] intoPrintController:controller];
...
- (void) loadContent:(NSString*)content intoPrintController:(UIPrintInteractionController*)controller
{
    ...
    if (YES) {
        ...
        NSData* data = [str dataUsingEncoding:NSUTF8StringEncoding];
         [page loadData:data MIMEType: @"text/html" textEncodingName: @"Base64" baseURL:[NSURL URLWithString:@""]];
    }
    else {
...
- (void) loadContent1:(NSString*)content intoPrintController:(UIPrintInteractionController*)controller
{
    UIWebView* page                 = [[UIWebView alloc] init];
    UIPrintPageRenderer* renderer   = [[UIPrintPageRenderer alloc] init];
    UIViewPrintFormatter* formatter = [page viewPrintFormatter];
